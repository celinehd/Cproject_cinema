...
#define Auditorium_SIZE 1 //A_SIZE indicates the number of auditoriums
#define ShowTime_SIZE 3 //S_SIZE indicates the number of showtimes for each auditorium.
